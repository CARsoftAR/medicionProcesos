...
def ejecutar_calibracion_directa():
    ...
    img_temp_png = r"C:\Sistemas ABBAMAT\medicionProcesos\temp_render_v2.png"
    try:
        import fitz
    ...
    # 📐 VALORES CALIBRADOS REALES (380, 62, 1092, 111)
    for c in range(1, 11):
    ...
    nombre_archivo_salida = "NUEVA_CALIBRACION_" + ts + ".png"
    out = os.path.join(r"C:\Sistemas ABBAMAT\medicionProcesos", nombre_archivo_salida)
    cv2.imwrite(out, img)
    ...
    print("==================================================")
    print(" ARCHIVO GENERADO EXITO: " + nombre_archivo_salida)
    print("==================================================")
