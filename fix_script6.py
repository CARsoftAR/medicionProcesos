...
html = re.sub(r'<button type="button" id="btn-procesar-json".*?</button>', '<button type="button" id="btn-procesar-json" class="btn btn-primary">PROCESAR JSON</button>', html)
...
with open('mediciones/templates/mediciones/ocr_lector.html', 'w', encoding='utf-8') as f:
    f.write(html)
print('Script reverted to eventListener safely')
