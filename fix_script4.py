    ...
    .then(data => {
        ...
        if (data.status === 'success' || data.cliente) {
            ...
            try {
                ...
                // Rellenar cabecera (etiquetas laterales y selectores)
                ...
                if (tbody) {
                    ...
                    controles.forEach(row => {
                        ...
                        if(!Array.isArray(rowVals)) {
                            // If row.valores is an object, try to map it by piece
                        ...
                        // Extraemos datos manejando posibles diferentes nombres (cota vs control, tol vs tolerancia)
...
with open('mediciones/templates/mediciones/ocr_lector.html', 'w', encoding='utf-8') as f:
    f.write(html)
print('Script with DOM rendering applied')
